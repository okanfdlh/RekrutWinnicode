...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Nov 2024 pada 02.28
...
(32009, 'indirokan@gmail.com', '1234', 'indirokan', 'Laki-Laki', ' indonesia', '2012-06-12', ' Islam ', 'jl. bagus ', '08984567828', '563727', 'HRD');
...
('LWG0001', 'WEB DEVELOPER', 'YOGYAKARTA', '2024-09-03', '2024-11-12', '<p>Deskripsi Pekerjaan Web Developer: &nbsp; &nbsp;Seorang Web Developer bertanggung jawab untuk merancang, mengembangkan, dan memelihara situs web. Mereka bekerja dengan bahasa pemrograman seperti HTML, CSS, JavaScript, dan teknologi backend untuk menciptakan tampilan dan fungsi yang optimal. Web Developer juga memastikan situs web responsif, aman, dan ramah pengguna, serta menangani debugging dan pemecahan masalah teknis.</p>', 'Teknik Informatika', 'Yogyakarta', '10088', 'aktif');
...
--
ALTER TABLE `admin`
  MODIFY `id_admin` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32010;
